...
import { CircleCheck, Eye, XCircle, EyeOff } from "lucide-react";
...
const ApproveLG = () => {
  ...
  const [selectedTeacher, setSelectedTeacher] = useState<LG | null>(null);
  ...
  const handleViewDetails = (teacher: LG) => {
    ...
    <div className={`min-h-screen p-4`}>
      ...
      <div className={`${details ? "col-start-7 flex" : ""}`}>
        ...
        {details && selectedTeacher ? (
          <CardDetails teacher={selectedTeacher} />
        ) : null}
      </div>
    </div>
  );
